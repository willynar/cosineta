...
namespace Cocinecta.Controllers.App
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                return Ok(await ICategoryService.GetAllCategorys());
            }
            catch (Exception exc)
            {
        ...
        public async Task<IActionResult> Get(int id)
        {
            try
            {
                return Ok(await ICategoryService.GetCategoryById(id));
            }
            catch (Exception exc)
            {
                var ErrorMsg = exc.GetBaseException().InnerException != null ? exc.GetBaseException().InnerException?.Message : exc.GetBaseException().Message ?? string.Empty;
        ...
        public async Task<IActionResult> Post([FromBody] Category product)
        {
            ...
            try
            {
                await ICategoryService.AddCategory(product);
        ...
        public async Task<IActionResult> Put(int id, [FromBody] Category product)
        {
            ...
            try
            {
                await ICategoryService.UpdCategoryById(product);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                await ICategoryService.DeleteCategoryById(id);
