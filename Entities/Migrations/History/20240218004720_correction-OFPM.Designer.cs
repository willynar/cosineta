...
namespace Entities.Migrations
{
    ...
    [Migration("20240218004720_correction-OFPM")]
    partial class correctionOFPM
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Administration.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("TypeIdNavigationTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TypeIdNavigationTypeId");
            ...
            modelBuilder.Entity("Entities.App.OrderProductFeacture", b =>
                {
                    ...
                    b.ToTable("OrderProductFeacture");
                });
            ...
            modelBuilder.Entity("Entities.App.OrderProductFeactureDetail", b =>
                {
                    ...
                    b.Property<int?>("OrderIdNavigationOrderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderIdNavigationOrderId");
            ...
            modelBuilder.Entity("Entities.App.ProductFeaturesDetail", b =>
                {
                    ...
                    b.Property<int?>("ProductFeaturesIdNavigationFeaturesId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductFeaturesIdNavigationFeaturesId");
            ...
            modelBuilder.Entity("Entities.Administration.ApplicationUser", b =>
                {
                    b.HasOne("Entities.Administration.Type", "TypeIdNavigation")
                        ...
                        .HasForeignKey("TypeIdNavigationTypeId");
            ...
            modelBuilder.Entity("Entities.App.ProductFeaturesDetail", b =>
                {
                    b.HasOne("Entities.App.ProductFeature", "ProductFeaturesIdNavigation")
                        ...
                        .HasForeignKey("ProductFeaturesIdNavigationFeaturesId");
